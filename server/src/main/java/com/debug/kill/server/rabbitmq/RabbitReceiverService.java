package com.debug.kill.server.rabbitmq;/**
...
import com.debug.kill.server.service.impl.MailService;
...
public class RabbitReceiverService {
     ...
     * @param dto
     */
    @RabbitListener(queues = {"${mq.kill.item.execute.limit.queue.name}"},
